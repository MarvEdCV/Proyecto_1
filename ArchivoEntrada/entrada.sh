...
rmDisk -path~:~/home/archivos/faseU/Disco4.disk
rmDisk -path~:~"/home/archivos/faseU/mario/Escritorio/Disco3.disk" #Error porque no existe
...
rmDisk -path~:~/home/archivos/faseU/Disco1.disk #Si tambine se arregla la escritura ya que estaba escrtio como RMDISCK
rmDisk -path~:~/home/archivos/faseU/Disco2.disk #Si tambine se arregla la escritura ya que estaba escrtio como RMDISCK

#Crea 2 discos
#CREANDO DISCOS ----------------------------------------------------------------------------------------
mkdisk -size~:~75 -unit~:~M -path~:~/home/archivos/faseU/Disco11.disk -fit~:~FF
mkdisk -unit~:~K -size~:~51200 -path~:~/home/archivos/faseU/Disco21.disk -fit~:~FF

#CREANDO PARTICIONES ----------------------------------------------------------------------------------
#Crear particiones Disco1.disk
fdisk -type~:~P -unit~:~M -name~:~Part1 -size~:~20 -path~:~/home/archivos/faseU/Disco11.disk -fit~:~FF
fdisk -type~:~P -unit~:~M -name~:~Part2 -size~:~15 -path~:~/home/archivos/faseU/Disco11.disk -fit~:~FF
fdisk -type~:~P -unit~:~M -name~:~Part3 -size~:~20 -path~:~/home/archivos/faseU/Disco11.disk -fit~:~FF

#Crear particiones Disco2.disk
fdisk -type~:~P -unit~:~M -name~:~Part1_D2 -size~:~20 -path~:~/home/archivos/faseU/Disco21.disk -fit~:~FF
fdisk -type~:~P -unit~:~M -name~:~Part2_D2 -size~:~10 -path~:~/home/archivos/faseU/Disco21.disk -fit~:~FF
fdisk -type~:~P -unit~:~M -name~:~Part3_D2 -size~:~10 -path~:~/home/archivos/faseU/Disco21.disk -fit~:~FF

#Monta las particiones

mount -path~:~/home/archivos/faseU/Disco11.disk -name~:~Part1 #vda1
mount -path~:~/home/archivos/faseU/Disco11.disk -name~:~Part2 #vda2
mount -path~:~/home/archivos/faseU/Disco11.disk -name~:~Part3 #vda3

mount -path~:~/home/archivos/faseU/Disco21.disk -name~:~Part1_D2 #vdb1
mount -path~:~/home/archivos/faseU/Disco21.disk -name~:~Part2_D2 #vdb2
mount -path~:~/home/archivos/faseU/Disco21.disk -name~:~Part3_D2 #vdb3
...
mkfile -p -path~:~"/home/ahora/yaexiste/b1.txt" -size~:~640
#File 1er Indirecto
