...
start_actual_isodate=if(@var4 is null,NULL,str_to_date(@var4,'%d/%m/%Y')),
end_actual_isodate=if(@var5 is null,NULL,str_to_date(@var5,'%d/%m/%Y')),
...
transaction_isodate=str_to_date(@var3,'%d/%m/%Y'),
